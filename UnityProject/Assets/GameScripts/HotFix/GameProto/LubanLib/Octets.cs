...
namespace Perfect.Marshal
{
    ...
    {
        [ThreadStatic]
        private readonly static Stack<Octets> pool = new Stack<Octets>();
        public static Octets Alloc()
        {
            if (pool.Count > 0)
            {
                return pool.Pop();
        ...
        public static void Free(Octets os)
        {
            os.Clear();
            pool.Push(os);
        }
        ...
        public void MarshalShort(short x)
        {
            this.WriteShort(x);
        }
        ...
        public void MarshalUInt(uint x)
        {
            WriteUint(x);
        }
        ...
        public void MarshalULong(ulong x)
        {
            this.WriteUlong(x);
        }
        ...
        public void MarshalSint(int x)
        {
            WriteSint(x);
        }

        public int UnmarshalSint()
        {
            return ReadSint();
        }
        ...
        public void MarshalSlong(long x)
        {
            WriteSlong(x);
        }

        public long UnmarshalSlong()
        {
            return ReadSlong();
        }
        ...
        public void MarshalOctets(Octets o)
        {
            WriteOctets(o);
        }
